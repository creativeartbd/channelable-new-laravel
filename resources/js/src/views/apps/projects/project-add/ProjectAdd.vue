          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider
                ...
                rules="required"
              >
               <b-form-select v-model="projects.country" :options="countries"/>
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            </b-form-group>
          </b-col>
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider
                ...
                rules="required"
              >
               <b-form-select v-model="projects.currency" :options="currencies"/>
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            </b-form-group>
          </b-col>
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider
                ...
                rules="required"
              >
               <b-form-select v-model="projects.timezone" :options="timezones"/>
                <small class="text-danger">{{ errors[0] }}</small>
              </validation-provider>
            </b-form-group>
          </b-col>
    ...
    validationForm() {
      ...
      // this.$validator.validateAll().then(result => {
        http.post('projects', this.projects).then(response => {
          ...
          this.$vs.notify({
            text:this.$i18n.t('Project has been successfully created.'),
            color:'success',
            iconPack: 'feather',
            icon:'icon-check'
          });
